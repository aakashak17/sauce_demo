...
WebUI.selectOptionByIndex(findTestObject('Swag Labs/Page_Swag Labs/Sorting Dropdown'), 2)

WebUI.click(findTestObject('Swag Labs/Page_Swag Labs/button - ADD TO CART Generic'))
